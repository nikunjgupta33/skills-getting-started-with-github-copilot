...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team drills and scrimmages for soccer players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["sarah@mergington.edu", "adam@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Improve basketball skills with shooting and conditioning exercises",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["jayden@mergington.edu", "hannah@mergington.edu"]
    },
    "Art Club": {
    ...
    "Science Club": {
        "description": "Explore science experiments and prepare for competitions",
